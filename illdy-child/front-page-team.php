		...
		<div class="container">
			<div class="row inline-columns">
				...
				elseif ( current_user_can( 'edit_theme_options' ) & defined( 'ILLDY_COMPANION' ) ) :
					...
					the_widget( 'Illdy_Widget_Person', 'title=' . __( 'Mark Lawrence', 'illdy' ) . '&image=' . get_template_directory_uri() . esc_url( '/layout/images/front-page/front-page-team-1.jpg' ) . '&position=' . __( 'Web Designer', 'illdy' ) . '&entry=' . __( 'Creative, detail-oriented, always focused.', 'illdy' ) . '&facebook_url=' . get_template_directory_uri() . esc_url( '#' ) . '&twitter_url=' . esc_url( '#' ) . '&linkedin_url=' . esc_url( '#' ) . '&color=#f18b6d', $the_widget_args );
